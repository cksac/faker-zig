...
pub const prefix = [_][]const u8{ "AO", "ГУП", "ЗАО", "ИП", "МУП", "НКО", "ОП", "ООО", "ОАО", "ПАО", "ТСЖ", "ФГУП" };

pub const suffix = [_][]const u8{ "Групп", "Инкорпорэйтед", "Лимитед", "Пром", "Рус", "Системс", "Сбыт", "Снаб", "Торг", "Трейд" };
